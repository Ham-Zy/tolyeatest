                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    <button type="button" onclick="openForm()" class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2" onclick="#">
                                        <i class="la la-shopping-cart"></i>
                                        <span class="d-none d-md-inline-block"> {{__('Contact Supplier')}}</span>
                                    </button>
